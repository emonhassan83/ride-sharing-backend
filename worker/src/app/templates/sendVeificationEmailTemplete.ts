...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 0; border: 1px solid #d4d4d4; border-radius: 12px; background-color: #ffffff; overflow: hidden;">
  <div style="background-color: #1a1a1a; padding: 22px 30px;">
    <h3 style="color: #ffffff; margin: 0; font-size: 18px; letter-spacing: 0.3px;">Email Verification</h3>
    <p style="color: #cfcfcf; margin: 6px 0 0 0; font-size: 13px;">Complete your SplitRide account setup</p>
  </div>

  <div style="padding: 30px;">
    <p style="margin: 0 0 14px 0; color: #333333; font-size: 14px; line-height: 1.6;">Dear <strong style="color: #1a1a1a;">{{name}}</strong>,</p>
    <p style="margin: 0 0 22px 0; color: #555555; font-size: 14px; line-height: 1.6;">Thank you for signing up. Please use the verification code below to verify your email address.</p>
